...
all.equal(unname(result1), unname(log_pred))
all.equal(unname(result1), unname(tree_pred))
all.equal(unname(result1), unname(rf_pred))
all.equal(unname(result1), unname(svm_pred))
